...
namespace yazlab
{
    public partial class grs : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            string l;
            int secilen = dataGridView1.SelectedCells[0].RowIndex;
            l = dataGridView1.Rows[secilen].Cells[0].Value.ToString();

            cn.Open();
            SqlCommand cmd = new SqlCommand("select pdf from ktp where ISBN = '" + l + "'  ", cn);
